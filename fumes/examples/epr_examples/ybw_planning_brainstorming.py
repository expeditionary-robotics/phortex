"""Sentry dive planning brainstorming document.

Second mission was used for Sentry 662."""
...
FLIGHT_ORIGIN = (9.9055599, -104.294361)  # Where we want the spirals to center
MIN_DEPTH = -2551.37
VEL = 1.0
