...
from fumes.environment import DynamicBullseye
from fumes.environment.utils import xcoord_circle, ycoord_circle, l_oscillate, \
    theta_oscillate
...
environment = DynamicBullseye(extent, xcoord_circle, ycoord_circle, l_oscillate,
                              theta_oscillate, l=20.0, A=10.0)
