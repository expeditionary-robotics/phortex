...
# Parameters
experiment_name = "fixed_traj_spiral"
traj_type = "spiral"  # type of fixed trajectory
...
if traj_type == "lawnmower":
    trajectory_base = Lawnmower(t0, vel, lh, lw, resolution, noise=0.1)
elif traj_type == "spiral":
    trajectory_base = Spiral(t0, vel, lh, lw, resolution, noise=0.1)
else:
