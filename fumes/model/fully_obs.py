...
class FullyObs(Model):
    ...
    def get_prediction(self, t, loc, **kwargs):
    ...
    def get_snapshot_prediction(self, t, **kwargs):
    ...
    def update(self, t, loc, obs, **kwargs):
    ...
    def update_multiple(self, t, loc, obs, **kwargs):
