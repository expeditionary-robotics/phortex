...
def data_home():
    """Get path to data storage directory."""
    path = os.getenv('FUMES_DATA')
...
TICTOC_asdfghh123456789 = TicToc2()
tic = TICTOC_asdfghh123456789.tic
toc = TICTOC_asdfghh123456789.toc
